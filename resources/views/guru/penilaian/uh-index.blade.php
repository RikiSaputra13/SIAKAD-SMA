                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($item->berkas_soal)
                                                    ...
                                                    <a href="{{ route('guru.penilaian.uh.show.soal', $item->id) }}"
                                                        class="btn btn-sm btn-outline-primary" title="Download Soal">
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="badge bg-{{ $item->status == 'published' ? 'success' : ($item->status == 'completed' ? 'info' : 'warning') }}">
                                                    {{ ucfirst($item->status) }}
                                                </span>
                                            </td>
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{ route('guru.penilaian.uh.submissions', $item->id) }}"
                                        ...
                                        <tr>
                                            <td colspan="9" class="text-center py-4">
                                                <div class="text-muted">
                                                    ...
                                                    <br>
                                                    <a href="{{ route('guru.penilaian.uh.create') }}"
