            ...
            <form action="{{ route('admin.siswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Biarkan sama jika tidak diubah.</small>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="tlp_orang_tua" class="form-control" value="{{ old('tlp_orang_tua', $siswa->tlp_orang_tua) }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="foto" class="form-label">Foto Profil</label>
                        <input type="file" name="foto" id="foto" class="form-control" accept="image/jpeg,image/png">
                        <small class="text-muted">Kosongkan jika tidak ingin diubah. Maksimal 2MB.</small>
                        <div class="mt-2">
                            @if($siswa->foto)
                                <img id="preview" src="{{ asset('storage/siswa/'.$siswa->foto) }}" alt="Foto Profil" style="max-width: 200px; max-height: 200px; border-radius: 5px;">
                            @else
