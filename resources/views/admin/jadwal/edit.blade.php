                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="mata_pelajaran" id="mata_pelajaran" 
                               class="form-control" value="{{ old('mata_pelajaran', $jadwal->mata_pelajaran) }}" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" name="jam_mulai" id="jam_mulai" 
                               class="form-control" value="{{ old('jam_mulai', $jadwal->jam_mulai) }}" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" name="jam_selesai" id="jam_selesai" 
                               class="form-control" value="{{ old('jam_selesai', $jadwal->jam_selesai) }}" required>
                    </div>
                </div>
